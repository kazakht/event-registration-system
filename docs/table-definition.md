...
|--------|--------|-----|-------|----------|--------------|------|
| イベントID | Id | uniqueidentifier | PK | ○ | - | 主キー、EF Core で自動生成 |
...
| 論理名 | 物理名 | 型 | PK/FK | Not Null | デフォルト値 | 備考 |
|--------|--------|-----|-------|----------|--------------|------|
| チケットID | Id | uniqueidentifier | PK | ○ | - | 主キー、EF Core で自動生成 |
...
| 論理名 | 物理名 | 型 | PK/FK | Not Null | デフォルト値 | 備考 |
|--------|--------|-----|-------|----------|--------------|------|
| ユーザーID | Id | uniqueidentifier | PK | ○ | - | 主キー、EF Core で自動生成 |
...
| 論理名 | 物理名 | 型 | PK/FK | Not Null | デフォルト値 | 備考 |
|--------|--------|-----|-------|----------|--------------|------|
| 登録ID | Id | uniqueidentifier | PK | ○ | - | 主キー、EF Core で自動生成 |
